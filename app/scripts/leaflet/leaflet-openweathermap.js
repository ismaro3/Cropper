...
L.OWM = L.TileLayer.extend({
    baseUrl: "http://cropper.tk:8080/http://{s}.tile.openweathermap.org/map/{layername}/{z}/{x}/{y}.png",
    options: {
        maxZoom: 18,
        showLegend: true,
...
L.OWM.Current = L.Class.extend({
    ...
    initialize: function(options) {
        ...
        this._map = null;
        this._urlTemplate = 'http://cropper.tk:8080/http://api.openweathermap.org/data/2.5/box/{type}?{appId}cnt=300&format=json&units=metric&bbox={minlon},{minlat},{maxlon},{maxlat},10';
