    ...
    .directive('toolbox', ['$compile', 'MapHandler', 'Users',
        function ($compile, MapHandler, Users) {
            return {
                ...
                link: function postLink($scope, $globalScope, elements) {
                    /**
                    ...
                    function setUpIntroJS() {
                        ...
                        drawFeatures.setAttribute('data-intro', 'These are the drawing tools. With them, you can create events, crops and notification zones, with a polygon or squared shape.');
                    ...
                    $globalScope.updateCoordinates = function (view) {
                        console.log("hola");
                    };
